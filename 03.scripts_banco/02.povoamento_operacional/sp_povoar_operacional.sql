...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO TB_VIAGEM (TITULO, LOCAL_ORIGEM, LOCAL_DESTINO, VALOR_PASSAGEM, TOTAL_VAGAS, DATA_PARTIDA, DATA_CHEGADA, DESCRICAO, STATUS, COD_MOTORISTA)
        VALUES (@TITULO, @LOCAL_ORIGEM, @LOCAL_DESTINO, @VALOR_PASSAGEM, @TOTAL_VAGAS, @DATA_PARTIDA, @DATA_CHEGADA, @DESCRICAO, 'DISPONIVEL', @COD_MOTORISTA)
